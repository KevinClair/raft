...
public class MessageEncoder extends MessageToByteEncoder<Message> {
    ...
    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, Message object, ByteBuf byteBuf) throws Exception {
        // 魔法值
        ...
        if (!object.getType().equals(MessageTypeEnum.HEART_BEAT_RESPONSE) && !object.getType().equals(MessageTypeEnum.HEART_BEAT_RQEUEST)) {
            // todo 序列化内容
            body = Serializer.serialize(object.getData());
            // 计算总长度
